...
session_start();
$id = $_SESSION['id'];
$getPosts = "http://localhost:4000/profile/feed/get/" . $id;
$jsonPosts = file_get_contents($getPosts);
$users = json_decode($jsonPosts, true);
...
<main class="main">
        ...
        <div class="containerPublication">
                <?php foreach($users as $user): ?>
                        <a class="buttonPublication" href="../Page/onepublication.php?id=<?=$user['post_id']?>">
